...
// New course pages
import DataScienceAIBusiness from "./pages/courses/DataScienceAIBusiness";
import AIAccountingFinancial from "./pages/courses/AIAccountingFinancial";
import AIProductManagement from "./pages/courses/AIProductManagement";
import GenerativeAIPromptEngineering from "./pages/courses/GenerativeAIPromptEngineering";
import AIDigitalMarketing from "./pages/courses/AIDigitalMarketing";
import AIFullStackDeveloper from "./pages/courses/AIFullStackDeveloper";
      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* New Course Routes */}
            <Route path="/courses/data-science-ai-business" element={<DataScienceAIBusiness />} />
            <Route path="/courses/ai-accounting-financial" element={<AIAccountingFinancial />} />
            <Route path="/courses/ai-product-management" element={<AIProductManagement />} />
            <Route path="/courses/generative-ai-prompt-engineering" element={<GenerativeAIPromptEngineering />} />
            <Route path="/courses/ai-digital-marketing" element={<AIDigitalMarketing />} />
            <Route path="/courses/ai-fullstack-developer" element={<AIFullStackDeveloper />} />
