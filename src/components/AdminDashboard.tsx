...
import { Users, Video, BookOpen, BarChart3, MessageSquare, Star } from 'lucide-react';
...
import TopCoursesManagement from './TopCoursesManagement';
...
const AdminDashboard = () => {
  ...
  const [showTopCoursesManagement, setShowTopCoursesManagement] = useState(false);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage courses that appear in the "Featured Courses" section on the homepage</p>
            </div>
            <Button 
              variant="outline" 
              onClick={() => setShowTopCoursesManagement(false)}
            >
              Back to Dashboard
            </Button>
          </div>

          <TopCoursesManagement />
        </div>
      </div>
    );
  }
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Button 
                  variant="outline" 
                  className="w-full justify-start"
                  onClick={() => setShowTopCoursesManagement(true)}
                >
                  <Star className="mr-2 h-4 w-4" />
                  Manage Homepage Courses
                </Button>
                <Button 
                  variant="outline" 
                  className="w-full justify-start"
