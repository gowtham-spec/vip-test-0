...
const DatabaseCoursesDisplay = () => {
  ...
  const fetchCourses = async () => {
    try {
      ...
      // Filter to show AI courses prominently
      ...
      // Prioritize AI courses by putting them first
      const sortedCourses = [...aiCourses, ...otherCourses];
      console.log(`🤖 Found ${aiCourses.length} AI courses, ${otherCourses.length} other courses`);
  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-component="database-courses">
  ...
  if (error) {
    return (
      <div className="text-center py-12" data-component="database-courses">
      ...
      <div className="text-center py-12" data-component="database-courses">
        <div className="bg-muted/30 rounded-lg p-8 max-w-md mx-auto">
          ...
          <p className="text-muted-foreground mb-4">
            No published courses found. Courses may be in draft status or not yet created.
          </p>
  ...
  return (
    <motion.section 
      className="py-8"
      data-component="database-courses"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground">
          Discover our latest course offerings ({courses.length} courses available)
        </p>
      </div>
